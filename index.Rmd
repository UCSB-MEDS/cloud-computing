...
.center[
<span style = 'font-size: 90%;'>While we configured and launched a "Free Tier" instance ~ which includes only 1 core ☹️~ you can configure much more powerful instances (with up to X cores) to run parallelized code.</span>
