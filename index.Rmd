...
<span style = 'font-size: 80%;'>I'll demonstrate these steps on my own computer, but you are welcome to [create an AWS account](https://portal.aws.amazon.com/billing/signup#/start/email) to follow along on your own computer as well.</span> 
...
.center[
<span style = 'font-size: 100%;'>[Here are my instructions for launch an Amazon EC2 instance to run R & RStudio.](https://docs.google.com/document/d/1Bxp7OMq1_d1l7sMD7qoh8c8cA0rhYIGx-nr4IchH98E/edit?usp=sharing) If you have suggestions on how to improve these instructions and/or correct any potential misinformation, please [file a issue on GitHub](https://github.com/UCSB-MEDS/cloud-computing/issues).</span> 

]

---
### `r fontawesome::fa("grip-lines-vertical", fill = "#93C6C2", a11y = "sem")` A use case:
